...
from header.opcoesModel import ( MENU_PESSOAL_QUADRO, MENU_DOCUMENTO, MENU_FORMACAO, MENU_ESTATISTICA, 
MENU_TRANSFERENCIA, MENU_PESSOAL_QUADRO, MENU_PERFIL, CARGOS_POLICIAL, PENAS_DISCIPLINAR)
